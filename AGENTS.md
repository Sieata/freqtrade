...
- **展示规范（2026-08-29，权威定义：STRATEGY_WORKFLOW 第〇节 0.4）**：凡展示 PnL——
  ① 逐年收益率按"**每年重置 $1,000 本金**"表达为百分比（当年利润÷1000），跨年不复利不共用额度
  （2024 年 $1,000、2025 年重新 $1,000）；② 年化给双口径：钱包（池规模×1.2×$1,000）与
  占仓（平均并发仓×$1,000）。validate_strategy.py / pool_review.py / 组合回测脚本已内置，手写报告照此。
